...
public class DeathBeamStatic {
	...
	// CONSTRUCTOR
	// ====================================================
	public DeathBeamStatic(float pX, float pY, float pWidth, float pAngle, GameLevel pGameLevel) {
		
		pGameLevel.mBasePositions.add(new float[] {pX, pY});
		
		ITextureRegion metalBeamStaticTRCopy = ResourceManager.gameMetalBeamDynamicTR.deepCopy();
		...
		MetalBeamStaticBody.setUserData("death_wall");
