...
public class LevelPauseLayer extends ManagedLayer {
	...
	public void onLoadLayer() {
		...
		final GrowButton ReturnToLevelButton = new GrowButton((-ResourceManager.getEngine().getCamera().getWidth() / 2f) + (ResourceManager.gamePauseButtonTR.getWidth() / 2f), (ResourceManager.getEngine().getCamera().getHeight() / 2f) - (ResourceManager.gamePauseButtonTR.getHeight() / 2f), ResourceManager.gamePauseButtonTR, false) {
			@Override
			public void onClick() {
		...
		this.mNextLevelButton = new GrowButton(383f, 75f, ResourceManager.gameLevelLayerButtonNextLevelTR, false) {
			@Override
			public void onClick() {
				LevelPauseLayer.this.mIsGoingToRestartLevel = false;
		...
		this.mMainText = new Text(0f, 0f, ResourceManager.fontDefault72Bold, "LEVEL *** PAUSED", ResourceManager.getActivity().getVertexBufferObjectManager());
		...
		this.mScoreText = new Text(0f, 0f, ResourceManager.fontDefault32Bold, "CURRENT SCORE: ******", ResourceManager.getActivity().getVertexBufferObjectManager());
		this.mScoreText.setScale(Math.min(352f / this.mScoreText.getWidth(), 1f));
		this.mScoreText.setPosition(256f, 157f);
		...
		this.mHighScoreText.setPosition(256f, 125f);
