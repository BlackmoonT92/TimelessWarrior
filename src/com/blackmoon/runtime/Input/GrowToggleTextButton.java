package com.blackmoon.runtime.Input;
...
public abstract class GrowToggleTextButton extends Text {
	...
	private CharSequence mTrueText;
	...
	public void setmTrueText( CharSequence trueText) {
		mTrueText = trueText;
	}
	
	public void setmFalseText( CharSequence falseText) {
		mTrueText = falseText;
	}
