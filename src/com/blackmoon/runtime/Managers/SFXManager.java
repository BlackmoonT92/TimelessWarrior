...
public class SFXManager extends Object
{
	...
	public SFXManager() {
		...
		try {
			mMusic = MusicFactory.createMusicFromAsset(ResourceManager.getActivity().getMusicManager(), ResourceManager.getActivity(), "music.mp3");
		...
		try {
			mJump = SoundFactory.createSoundFromAsset(ResourceManager.getActivity().getSoundManager(), ResourceManager.getActivity(), "jump.mp3");
		} catch (final IOException e) { Debug.e(e); }
	}
	...
	public static void setSoundMuted(final boolean pMuted) {
		...
		TimelessWarriorsActivity.writeIntToSharedPreferences(TimelessWarriorsActivity.SHARED_PREFS_SOUNDS_MUTED, (getInstance().mSoundsMuted? 1:0));
	}
	...
	public static void setMusicMuted(final boolean pMuted) {
		...
		TimelessWarriorsActivity.writeIntToSharedPreferences(TimelessWarriorsActivity.SHARED_PREFS_MUSIC_MUTED, (getInstance().mMusicMuted? 1:0));
	}
	...
	public static void playJump(final float pRate, final float pVolume) {
		playSound(mJump,pRate,pVolume);
	}
