...
import com.blackmoon.object.TexturedMesh;
import com.blackmoon.object.TexturedMesh.DrawMode;
...
public class TexturedBezierLandscape {
	...
	public TexturedBezierLandscape(float pStartY, float pWidth, float[] pSlopes, GameLevel pGameLevel) {
		...
		Body body= PhysicsFactory.createTrianglulatedBody(pGameLevel.mPhysicsWorld, groundEnt, groundVerts, BodyType.StaticBody, mGROUND_FIXTURE_DEF);
		body.setUserData("static_wall");
